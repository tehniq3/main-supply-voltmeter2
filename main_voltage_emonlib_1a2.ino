...
lc.setDigit(0,3,vs, false); // afisez sute  pe coloana 2
lc.setDigit(0,2,vz, false); // afisez zeci pe coloana 1
lc.setDigit(0,1,vu, true); // afisez unitati pe coloana 1
lc.setDigit(0,0,vm, false); // afisez cifra dupa virgula pe coloana 1
}
