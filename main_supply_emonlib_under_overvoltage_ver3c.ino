...
// base version 1.0 in 22.11.2016, Craiova - Romania
// actual version 1a2 in 23.09.2016
...
//lc.setChar(0,7,' ',true);
lc.setRow(0,7,B10111110);  // afisez litera "U" pe coloana 7
delay(50);
voltage = vtot/10;
...
lc.setDigit(0,3,vs, false); // afisez sutele pe coloana 3
lc.setDigit(0,2,vz, false); // afisez zecile pe coloana 2
lc.setDigit(0,1,vu, true); // afisez unitatile pe coloana 1
lc.setChar(0,0,vv,false); 
...
lc.setChar(0,5,' ',false); 
lc.setChar(0,4,' ',false); 
lc.setDigit(0,3,5, false); // afisez un 5 pe coloana 2
lc.setRow(0,2,B01001111);  // afisez litera "E" cu bara sus
lc.setRow(0,1,B00001111);  // afisez litera "t" cu bara sus
...
lc.setChar(0,5,' ',false); 
lc.setChar(0,4,' ',false); 
lc.setRow(0,3,B01011100);  // afisez litera "u" cu bara sus
lc.setDigit(0,2,unders, false); // afisez sute pe coloana 3
lc.setDigit(0,1,underz, false); // afisez zeci pe coloana 2
lc.setDigit(0,0,underu, true); // afisez unitati pe coloana 1
...
lc.setChar(0,5,' ',false); 
lc.setChar(0,4,' ',false); 
lc.setRow(0,3,B00101011);  // afisez litera "u" cu bara jos
lc.setDigit(0,2,overs, false); // afisez sute pe coloana 3
lc.setDigit(0,1,overz, false); // afisez zeci pe coloana 2
lc.setDigit(0,0,overu, true); // afisez unitati pe coloana 1
...
lc.setChar(0,7,' ',false); //print a blank in the sign column 
lc.setChar(0,6,' ',false); 
lc.setChar(0,5,' ',false); 
lc.setChar(0,4,' ',false); 
lc.setRow(0,3,B00001111);  // afisez litera "t" cu bara sus
lc.setChar(0,2,' ',false); 
lc.setDigit(0,1,intarzierez, false); // afisez zeci pe coloana 2
lc.setDigit(0,0,intarziereu, false); // afisez unitati pe coloana 1
